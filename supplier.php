...
.box:focus{
    ...
    <body id="body-pd">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="supplier.php" class="nav__link active">
      ...
      <a href="tambah_sup.php" style="text-align: left;" id="add"> <i class='bx bxs-plus-square'></i>
      Tambah Data Supplier</a>
      <a href="cetak_sup.php" id="print"><i class='bx bx-printer'></i>
 Cetak Data</a>
  ...
  <tr>
     ...
     <td><?= $row["alamat"]; ?></td>
     <td>
       <a href="ubah_sup.php?ids=<?= $row['ids']; ?>" id="up" class='bx bx-pen nav__icon'></a>
       <a href="hapus_sup.php?ids=<?= $row['ids']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tersebut?');" id="del" class='bx bx-trash nav__icon'></a>
     </td>
  </tr>
  <?php endforeach; ?>
 </table>   
