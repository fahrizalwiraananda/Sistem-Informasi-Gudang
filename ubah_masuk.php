...
$sw=query("select * from masuk where idm=$idm")[0];
    ...
    <form method="POST" action="" enctype="multipart/form-data">
      ...
      <ul>
        ...
        <li>
          ...
          <input type="text" name="idm" id="idm" required value="<?= $sw["idm"]; ?>">
        </li>
        </div>
        ...
        <li>
          ...
          <input type="text" name="barang" id="barang" value="<?= $sw["barang"]; ?>">
        </li>
        </div>
        ...
        <li>
          ...
          <input type="text" name="supplier" id="supplier" value="<?= $sw["supplier"]; ?>">
        </li>
        </div>
        ...
        <li>
          ...
          <input type="text" name="tgl_masuk" id="tgl_masuk" value="<?= $sw["tgl_masuk"]; ?>">
        </li>
        </div>

        <div class="input-box">
        <li>
          <label for="jumlah" class="details">Jumlah Masuk :</label>
        ...
        <div class="input-box">
        <li>
          <label for="total" class="details">Total Keseluruhan :</label>
          <input type="text" name="total" id="total" value="<?= $sw["total"]; ?>">
        </li>
        </div>
