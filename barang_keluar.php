...
session_start();
  ...
  include 'functions_bk.php';
    $data= query("select * from keluar");
...
<html lang="en">
    <head>
        ...
        <title>Halaman Data Barang Keluar</title>
        <style>
...
.box:focus{
    ...
    <body id="body-pd">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="barang_keluar.php" class="nav__link active">
      ...
      <a href="tambah_bk.php" style="text-align: left;" id="add"> <i class='bx bxs-plus-square'></i>Tambah Data Barang Keluar</a>
      <a href="print.php" style="text-align:left" id="print"> <i class='bx bx-printer'></i>
Cetak Data</a>
  ...
  <tr>
     ...
     <td><?= $row["jml"]; ?></td>
     <td><?= $row["sisa"]; ?></td>
     <td><img src="gambar/<?= $row["foto"]; ?>" width="50"></td>
     <td>
       <a href="ubah_bk.php?idb=<?= $row['idb']; ?>" id="up" class='bx bx-pen nav__icon'></a>
       <a href="hapus_bk.php?idb=<?= $row['idb']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tersebut?');" id="del" class='bx bx-trash nav__icon'></a>
     </td>
  </tr>
  <?php endforeach; ?>
 </table> 
