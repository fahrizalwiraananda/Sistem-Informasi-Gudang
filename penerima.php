...
.box:focus{
    ...
    outline: none;
        ...
        <title>Halaman Data Penerima</title>
    </head>
    <body id="body-pd">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="penerima.php" class="nav__link active">
...
<form action="" method="POST">
    <a href="tambah_penerima.php" id="add"> <i class='bx bxs-plus-square'></i>
      Tambah Data Penerima</a>
    <a href="cetak_penerima.php" id="print"><i class='bx bx-printer'></i> Cetak Data</a>
  ...
  <tr>
     ...
     <td>
       <a href="ubah_penerima.php?idp=<?= $row['idp']; ?>" id="up" class='bx bx-pen nav__icon'></a>
       <a href="hapus_penerima.php?idp=<?= $row['idp']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tersebut?');" id="del" class='bx bx-trash nav__icon'></a>
     </td>
  </tr>
  <?php endforeach; ?>
 </table> 
