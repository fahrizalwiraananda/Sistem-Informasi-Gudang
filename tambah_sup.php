...
<div class="container">
		<form method="POST" action="" enctype="multipart/form-data">
			...
			<ul>
				...
				<div class="input-box">
				<li>
					<label for="ids" class="details">ID Supplier :</label>
					<input type="text" name="ids" id="ids" required>
				</li>
				</div>
				<div class="input-box">
				<li>
					<label for="namasp" class="details">Supplier :</label>
					<input type="text" name="namasp" id="namasp" required>
				</li>
				</div>
				<div class="input-box">
				<li>
					<label for="no_telp" class="details">No Telphone :</label>
